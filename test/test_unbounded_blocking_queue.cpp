...
TEST(MpmcUnboundedBlockingQueue, PushAndPopSingleThread) {
...
TEST(MpmcUnboundedBlockingQueue, PushMove) {
...
TEST(MpmcUnboundedBlockingQueue, WaitAndPopWhenEmpty) {
    walle::core::mpmc_unbounded_blocking_queue<int> queue;
...
TEST(MpmcUnboundedBlockingQueue, WakeAndDonePreventsNewPushes) {
    walle::core::mpmc_unbounded_blocking_queue<int> queue;
...
TEST(MpmcUnboundedBlockingQueue, MultipleProducersConsumers) {
    walle::core::mpmc_unbounded_blocking_queue<int> queue;
