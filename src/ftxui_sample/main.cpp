...
// configuration step. It creates a namespace called `walle`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", walle::cmake::project_name, walle::cmake::project_version) };
